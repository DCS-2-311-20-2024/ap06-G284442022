...
function init() {
  ...
  THREE.AmbientLight.castShadow=true;
  scene.add(ambLight);
  ...
  const desk=new THREE.Mesh(
    new THREE.BoxGeometry(10,6),
    new THREE.MeshPhongMaterial({color:0xB08030})
  );
  desk.rotation.x=29.85;
  desk.position.y=-(std.H/4+dpy.H+std.T/2);
